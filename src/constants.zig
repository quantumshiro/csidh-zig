...
const pbits: u64 = 1020;

const p: uint = .{ .c = [_]u64{
...
const zero: fp = .{ .c = [_]u64{0} };
const one: fp = .{ .c = [_]u64{
...
const r_squared_mod_p: fp = .{ .c = [_]u64{
...
// -p^-1 mod 2^64
const inv_min_p_mod_r: u64 = 0xd2c2c24160038025;

// p - 2
const p_minus_2: uint = .{ .c = [_]u64{
...
// (p - 1) / 2
const p_minus_1_halves: uint = .{ .c = [_]u64{
